...
module.exports = {
  ...
  sendTweet: (msg) => {
    ...
    {
      tweet = tweet + msg["team1_id"] + " are a  " + parseFloat((msg["team1_win_percentage_live"])*100).toFixed(4) + "% favorite ";
      tweet = tweet + " over " +  msg["team2_id"] ;
    }
    else
    {
      tweet = tweet + msg["team2_id"] + " are a  " + parseFloat((msg["team2_win_percentage_live"])*100).toFixed(4) + "% favorite ";
